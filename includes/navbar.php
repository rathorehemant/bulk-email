      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="<?=site_url?>dashboard.php" class="nav-link <?php echo ($current_page == 'dashboard.php') ? 'active' : ''; ?>">
          ...
          <li class="nav-item">
            <a href="<?=site_url?>send-mail.php" class="nav-link <?php echo ($current_page == 'send-mail.php') ? 'active' :''; ?>">
          ...
          <!--<li class="nav-item ">-->
          <!--  <a href="<?=site_url?>smtp-settings.php" class="nav-link <?php echo ($current_page == 'smtp-settings.php') ? 'active' :''; ?>">-->
